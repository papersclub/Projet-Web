                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="livreur-edit.html">Edit Livreur</a>
                            </div>
                            <table id="myTable">
                               <tr>
                                    <th onclick="sortTable(0)">Référence</th>
                                    <th onclick="sortTable(1)">Nom</th>
                                    <th onclick="sortTable(2)">Prix</th>
                                    <th onclick="sortTable(3)">Quantité</th>
                                    <th onclick="sortTable(4)">Description</th>
                                    <th onclick="sortTable(5)">Catégorie</th>
                                ...
                                <tr>
                                    ...
                                    <td><a href="livreur-edit.php?ref=<?php echo $row['cin']; ?>">Modifier</a></td> 
                                      <td>  
                                        
                                        <form method="POST" action="supprimer-livreur.php"> 
                                        <input type="hidden" value="<?php echo $row['cin']; ?>" name="cinS">
